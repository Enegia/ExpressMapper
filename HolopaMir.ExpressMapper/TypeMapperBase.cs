...
namespace ExpressMapper
{
    public abstract class TypeMapperBase<T, TN> : IMemberConfigParameters
    {
        ...
        protected void ProcessAutoProperties()
        {
            ...
            /* MODIFIED FROM ORIGINAL BY: Miro Holopainen, 2018-01-04 */
            var comparer = StringComparer.OrdinalIgnoreCase; //CultureInfo.CurrentCulture.CompareInfo.GetStringComparer(CompareOptions.OrdinalIgnoreCase)
